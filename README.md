...
- Обновление безопасности скрипта
  ...
  - Добавлена функция ручной проверки наличия новой версии файла критических ошибок (Опция 24) с проверкой хеша файла и запросом подтверждений от пользователя. При первом запуске необходимо запустить опцию, чтобы скачать файл с критическими ошибками error_definitions.json.
