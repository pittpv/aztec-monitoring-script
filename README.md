...
## 📌 Последние обновления 10-12-2025
...
- **Мониторинг балансов publisher адресов (опция 10)**
  ...
  - Форматирование сообщений с балансами:
    ...
    - Исправлено отображение балансов с ведущим нулем (например, 0.000001 вместо .000001)
...
- **Обновление переводов и сообщений**
  ...
  - Исправлены ссылки на номера опций в подсказках (BLS генерация - опция 18, Approve - опция 19, Stake - опция 20)
  - Обновлено сообщение об ошибке синхронизации (опции 13 и 14 для start/stop)
