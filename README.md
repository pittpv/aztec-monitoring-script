...
- Генерация BLS-ключей из мнемонической фразы для вашего старого секвенсора (требуется установка ноды через этот скрипт)
  - поддержка нескольких адресов из одной мнемоники 
  - автоматическая фильтрация и удаление лишних ключей
- Функция апрува стейка (требуется установка ноды через этот скрипт)
- Функция стейкинга - добавления валидатора (требуется установка ноды через этот скрипт)
...
18. Сгенерировать BLS ключи из мнемонической фразы
19. Аппрув
20. Стейк
