...
Данное исправление увеличивает совместимость мониторинга с различными версиями systemd. Если вы столкнулись с проблемами в работе мониторинга, то обновление до текущей версии рекомендуется.
