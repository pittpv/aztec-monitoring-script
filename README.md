...
⚠️ После обновления скрипта убедитесь, что установлена версия ноды не менее **3.0.3**. Если версия более ранняя, то используйте опцию дайнгрейда для установки версии ноды 3.0.3! Удалите старый агент мониторинга (опция 3) и создайте нового агента (опция 2).
