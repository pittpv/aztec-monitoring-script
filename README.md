...
## 📌 Последние обновления 05-12-2025

Данное исправление увеличивает совместимость мониторинга с различными версиями systemd и Ubuntu. Если вы столкнулись с проблемами в работе мониторинга, то обновление до текущей версии рекомендуется.
