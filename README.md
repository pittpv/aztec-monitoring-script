...
- Функция Просмотреть логи Aztec - доработана для показ последних 500 строк с последующим обновлением.
- Функция Проверить контейнер и актуальный блок - доработка улучшеного чтения логов и предотвращением проблем с памятью
