...
- Очистит лог файл при достижении размера в 1 Мб, сохранив самый первый отчет. *(обновление агента от 29.05.2025)*	
...
Если вышло обновление для cron-агента, снчала обновите весь скрипт. После удалите старый агент и создайте новый.
