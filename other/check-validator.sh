...
init_languages() {
  ...
  TRANSLATIONS["en,option1"]="Search and display data for a specific validator"
  TRANSLATIONS["en,option2"]="Display the full validator list"
  TRANSLATIONS["en,option3"]="Exit"
