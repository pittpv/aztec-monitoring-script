...
init_languages() {
  ...
  TRANSLATIONS["en,log_block_not_found"]="❌ No line with block number found in logs"
  ...
  TRANSLATIONS["ru,log_block_not_found"]="❌ В логах не найдена строка с номером блока"
  ...
  TRANSLATIONS["tr,log_block_not_found"]="❌ Loglarda blok numarası içeren bir satır bulunamadı"
